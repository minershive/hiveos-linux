...
'--proto' - specify stratum protocol mode, possible values: proxy and stratum, useful for Ethash mining
...
FAQ
Q: How to connect to NiceHash/MiningPoolHub/Altpool for Ethash mining?
A: You have to add "--proto stratum" to command line arguments for each server 
