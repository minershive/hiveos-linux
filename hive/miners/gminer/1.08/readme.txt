...
'--algo' or shortly '-a' - mining algorithm ('equihash144_5' or 'equihash192_7' or shortly: '144_5', '192_7')
...
'--color' or shortly '-c' - enable/disable color output for console, can be empty, default value is '1' ('0' - off or '1' - on)
...
'--pec' - enable power efficiency calculator, display of energy efficiency statistics of GPU in S/w, higher CPU load

DevFee:
Fee is 2%

Telemetry:
You can monitor GMiner's statistics via "Awesome Miner", to do this, add an external miner and select "BTMiner NebuTech compatible".
