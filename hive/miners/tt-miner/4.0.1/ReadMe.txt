...
-i, -mi            Comma or space separated list of intensities that should be used mining. First value
-intensity         for first GPU and so on. A single value sets the same intensity to all GPUs. A value
