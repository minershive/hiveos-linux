...
-----------
Changes in v0.7.6.4
- Added beta support for Nimiq (dumb mode only, network adapter is necessary for now).
- Integrated Nimiq node.js network proxy into the miner.
