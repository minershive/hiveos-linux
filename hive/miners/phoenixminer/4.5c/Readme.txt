...
ethermine.org (ETH):
  ./PhoenixMiner -pool eu1.ethermine.org:4444 -pool2 us1.ethermine.org:4444 -wal YourEthWalletAddress.WorkerName -proto 3
ethermine.org (ETH, secure connection):
  ./PhoenixMiner -pool ssl://eu1.ethermine.org:5555 -pool2 ssl://us1.ethermine.org:5555 -wal YourEthWalletAddress.WorkerName -proto 3
ethpool.org (ETH):
  ./PhoenixMiner -pool eu1.ethpool.org:3333 -pool2 us1.ethpool.org:3333 -wal YourEthWalletAddress.WorkerName -proto 3  
dwarfpool.com (ETH):
  ./PhoenixMiner -pool eth-eu.dwarfpool.com:8008 -wal YourEthWalletAddress/WorkerName -pass x
nanopool.org (ETH):
  ./PhoenixMiner -pool eth-eu1.nanopool.org:9999 -wal YourEthWalletAddress/WorkerName -pass x
nicehash (ethash):
  ./PhoenixMiner -pool stratum+tcp://daggerhashimoto.eu.nicehash.com:3353 -wal YourBtcWalletAddress -pass x -proto 4 -stales 0
f2pool (ETH):
  ./PhoenixMiner -epool eth.f2pool.com:8008 -ewal YourEthWalletAddress -pass x -worker WorkerName  
miningpoolhub (ETH):
  ./PhoenixMiner -pool us-east.ethash-hub.miningpoolhub.com:20535 -wal YourLoginName.WorkerName -pass x -proto 1
coinotron.com (ETH):
  ./PhoenixMiner -pool coinotron.com:3344 -wal YourLoginName.WorkerName -pass x -proto 1
ethermine.org (ETC):
  ./PhoenixMiner -pool eu1-etc.ethermine.org:4444 -wal YourEtcWalletAddress.WorkerName
dwarfpool.com (EXP):
  ./PhoenixMiner -pool exp-eu.dwarfpool.com:8018 -wal YourExpWalletAddress/WorkerName
miningpoolhub (MUSIC):
  ./PhoenixMiner -pool europe.ethash-hub.miningpoolhub.com:20585 -wal YourLoginName.WorkerName -pass x -proto 1
maxhash.org (UBIQ):
  ./PhoenixMiner -pool ubiq-us.maxhash.org:10008 -wal YourUbqWalletAddress -worker WorkerName -coin ubq
ubiq.minerpool.net (UBIQ):
  ./PhoenixMiner -pool lb.geo.ubiqpool.org:8001 -wal YourUbqWalletAddress -pass x -worker WorkerName -coin ubq
ubiqpool.io (UBIQ):
  ./PhoenixMiner -pool eu2.ubiqpool.io:8008 -wal YourUbqWalletAddress.WorkerName -pass x -proto 4 -coin ubq
minerpool.net (PIRL):
  ./PhoenixMiner -pool pirl.minerpool.net:8002 -wal YourPirlWalletAddress -pass x -worker WorkerName
...
Nicehash (Ethash + Blake2s):
  ./PhoenixMiner -pool stratum+tcp://daggerhashimoto.eu.nicehash.com:3353 -wal YourBtcWalletAddress -pass x -proto 4 -stales 0 -dpool blake2s.eu.nicehash.com:3361 -dwal YourBtcWalletAddress -dcoin blake2s
...
Pool options:
  ...
  -dpass <password> Dual mining password (most pools don't require it, use 'x' as password if unsure)
...
Mining options:
  ...
  -gt <n> Set the GPU tuning parameter (6 to 400). The default is 15. You can change the
	  ...
	  the miner will use auto-tuning to determine the best GT value. Note that you have to run auto-tune again as the
          optimal GT values are completely different for the green kernels. Also note that when the GPU is
...
files. If you run ./PhoenixMiner without any options, it will search for the file config.txt
...
P006: Immediately after starting, PhoenixMiner stops working and the last message is "debugger detected"
      S: If you have only Nvidia cards, add the option -nvidia to the ./PhoenixMiner command line.
